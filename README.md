...
The human-selected viewpoints can be accessed [here](https://github.com/zzc-1998/VP_PCQA/blob/main/human_preferred_index.csv). (`human_preferred_index.csv' in this repo)
